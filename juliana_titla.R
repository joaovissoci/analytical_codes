...
#file <- file.choose()
dados <- read.csv("/home/joao/Desktop/juliana_titles.csv", header = TRUE)
...
corpus = Corpus(VectorSource(dados$title))
...
Q2_atleta2 <- qgraph(cor$correlations, borders = FALSE, cut=0.4, minimum = 0.1, labels=names,label.cex = 0.80, label.color="black",layout = "spring",directed=FALSE,label.scale=FALSE,gray=FALSE,posCol=c("gray","gray"))

g<-as.igraph(Q1_atleta1)
