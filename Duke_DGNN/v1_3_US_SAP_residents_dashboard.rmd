...
registerOptions(api_token="s8KOkJ82hEwwuMXpTinSG9tzrNYJIGV0U9Z5CiD2", 
				base_url="duke.qualtrics.com")

surveys <- getSurveys() 

mysurvey <- getSurvey(surveyID = surveys$id[5], 
                      verbose = TRUE) # You can set this option globally
                                      # or pass it to the function.
data_01<-with(mysurvey,data.frame(
				# q2_feedback_during_operation=Q2actual,
				q6_zones_use=Q6, 
				case_date=CaseDate,
				resident=Resident, 
				year=PGY, 
