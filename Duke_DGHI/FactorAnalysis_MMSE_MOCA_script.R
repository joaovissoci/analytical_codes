...
#Mac
data<-read.csv("/Users/Joao/Box Sync/Home Folder jnv4/Data/Global EM/Africa/Tz/MH post TBI in Tz/Tz_MHpostTBI_data.csv",sep=',')
...
data_externalcorrelation<-read.csv("/Users/Joao/Downloads/Data_correlation_MMSE.csv",sep=',')
...
setEPS()
postscript("/Users/Joao/Desktop/image01.eps", width = 8, height = 8)
