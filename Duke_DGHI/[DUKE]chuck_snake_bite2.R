...
nadir2_platelets_rs<-apply(nadir1_platelets_rs,2,function(x) car::recode(x,"NA=9999"))
...
nadir2_fibrinogen_rs<-sapply(nadir1_fibrinogen_rs,function(x) car::recode(x,"NA=9999"))
...
nadir2_platelets_cp<-sapply(nadir1_platelets_cp,function(x) car::recode(x,"NA=9999"))
...
nadir2_fibrinogen_cp<-sapply(nadir1_fibrinogen_cp,function(x) car::recode(x,"NA=9999"))
...
var(data_rs_table2$baselineplateletcountkmm3)
sd(data_rs_table2$baselineplateletcountkmm3)
...
var(data_cp_table2$baselineplateletcountkmm3)
sd(data_cp_table2$baselineplateletcountkmm3)
...
c(ci_lower, ci_upper)
var(data_cp_table2$baselineplateletcountkmm3)
sd(data_cp_table3$baselinefibrinogencountmgdl)
...
# postscript("/Users/jnv4/Desktop/platelets_color.eps",width = 1200, 
# 	height = 1000)

	plot(platelets_cp, type="o", col="red", ylim=c(80,400),
	...
	par(adj=0)
	title(sub=expression("Figure 1. Average (lines) and distribution (dots) of Platelets" ~ 10^{9} ~ "/L count over time."))#,line=-33)
dev.off()
...
tiff("/Users/jnv4/Desktop/fibrinogen.tiff", units='in', width = 8,
  height = 6,compression = 'lzw',res=1200,bg = "white")
...
legend(4, 180, c("Copperhead","Other Crotaline"), cex=0.8,
	col=c("red","black"), pch=21:24, lty=1:4,bg="white")
par(adj=0)
	title(sub=expression("Figure 2.  Average (lines) and distribution (dots) of Fibrogen mg/dL count over time."))#,
		#line=-23)
dev.off()
...
tiff("/Users/jnv4/Desktop/platelets_SD.tiff", units='in', width = 8,
 height = 6,compression = 'lzw',res=1200,bg = "white")
# postscript("/Users/jnv4/Desktop/platelets_SD.eps",width = 800, 
	# height = 600)

platelets2<-na.omit(platelets)
platelets_rs2<- c(
	with(subset(platelets2,platelets2$group=="Rattlesnake"),
		mean(baseline)),
    with(subset(platelets2,platelets2$group=="Rattlesnake"),
    	mean(na.omit(T1))),
	with(subset(platelets2,platelets2$group=="Rattlesnake"),
...
platelets_cp2<- c(
	with(subset(platelets2,platelets2$group=="Copperhead"),
		mean(baseline)),
    with(subset(platelets2,platelets2$group=="Copperhead"),
    	mean(na.omit(T1))),
	with(subset(platelets2,platelets2$group=="Copperhead"),
...
# PLATELETS
plot(platelets_cp2, type="o", col="red", ylim=c(100,350),axes=FALSE,
	ann=FALSE)
lines(platelets_rs2, type="o", pch=22, lty=2, col="black")
# Make x axis using tests labels
axis(1, at=1:5, lab=c("Baseline","Nadir","5 days" ,"8 days","15 days"))
axis(2, at=seq(from = 100, to = 400, by = 20))

title(xlab="Follow Up")
title(ylab="Platelets") #, col.lab=rgb(0,0.5,0)
legend(4, 130, c("Copperhead","Other Crotaline"), cex=0.8,
	col=c("red","black"), pch=c(21,22), lty=1:4,bg="white")
segments(1,mean(platelets2$baseline[platelets2$group=="Rattlesnake"]),1,(mean(platelets2$baseline[platelets2$group=="Rattlesnake"])-sd(platelets2$baseline[platelets2$group=="Rattlesnake"])),col='black')
segments(0.95,(mean(platelets2$baseline[platelets2$group=="Rattlesnake"])-sd(platelets2$baseline[platelets2$group=="Rattlesnake"])),1.05,(mean(platelets2$baseline[platelets2$group=="Rattlesnake"])-sd(platelets2$baseline[platelets2$group=="Rattlesnake"])),col='black')
segments(1,mean(platelets2$baseline[platelets2$group=="Copperhead"]),1,(mean(platelets2$baseline[platelets2$group=="Copperhead"])+sd(platelets2$baseline[platelets2$group=="Copperhead"])),col='red')
segments(0.95,(mean(platelets2$baseline[platelets2$group=="Copperhead"])+sd(platelets2$baseline[platelets2$group=="Copperhead"])),1.05,(mean(platelets2$baseline[platelets2$group=="Copperhead"])+sd(platelets2$baseline[platelets2$group=="Copperhead"])),col='red')

segments(2,mean(platelets2$T1[platelets2$group=="Rattlesnake"]),2,(mean(platelets2$T1[platelets2$group=="Rattlesnake"])-sd(platelets2$T1[platelets2$group=="Rattlesnake"])),col='black')
segments(1.95,(mean(platelets2$T1[platelets2$group=="Rattlesnake"])-sd(platelets2$T1[platelets2$group=="Rattlesnake"])),2.05,(mean(platelets2$T1[platelets2$group=="Rattlesnake"])-sd(platelets2$T1[platelets2$group=="Rattlesnake"])),col='black')
segments(2,mean(platelets2$T1[platelets2$group=="Copperhead"]),2,(mean(platelets2$T1[platelets2$group=="Copperhead"])+sd(platelets2$T1[platelets2$group=="Copperhead"])),col='red')
segments(1.95,(mean(platelets2$T1[platelets2$group=="Copperhead"])+sd(platelets2$T1[platelets2$group=="Copperhead"])),2.05,(mean(platelets2$T1[platelets2$group=="Copperhead"])+sd(platelets2$T1[platelets2$group=="Copperhead"])),col='red')

segments(3,mean(platelets2$T2[platelets2$group=="Rattlesnake"]),3,(mean(platelets2$T2[platelets2$group=="Rattlesnake"])-sd(platelets2$T2[platelets2$group=="Rattlesnake"])),col='black')
segments(2.95,(mean(platelets2$T2[platelets2$group=="Rattlesnake"])-sd(platelets2$T2[platelets2$group=="Rattlesnake"])),3.05,(mean(platelets2$T2[platelets2$group=="Rattlesnake"])-sd(platelets2$T2[platelets2$group=="Rattlesnake"])),col='black')
segments(3,mean(platelets2$T2[platelets2$group=="Copperhead"]),3,(mean(platelets2$T2[platelets2$group=="Copperhead"])+sd(platelets2$T2[platelets2$group=="Copperhead"])),col='red')
segments(2.95,(mean(platelets2$T2[platelets2$group=="Copperhead"])+sd(platelets2$T2[platelets2$group=="Copperhead"])),3.05,(mean(platelets2$T2[platelets2$group=="Copperhead"])+sd(platelets2$T2[platelets2$group=="Copperhead"])),col='red')

segments(4,mean(platelets2$T3[platelets2$group=="Rattlesnake"]),4,(mean(platelets2$T3[platelets2$group=="Rattlesnake"])-sd(platelets2$T3[platelets2$group=="Rattlesnake"])),col='black')
segments(3.95,(mean(platelets2$T3[platelets2$group=="Rattlesnake"])-sd(platelets2$T3[platelets2$group=="Rattlesnake"])),4.05,(mean(platelets2$T3[platelets2$group=="Rattlesnake"])-sd(platelets2$T3[platelets2$group=="Rattlesnake"])),col='black')
segments(4,mean(platelets2$T3[platelets2$group=="Copperhead"]),4,(mean(platelets2$T3[platelets2$group=="Copperhead"])+sd(platelets2$T3[platelets2$group=="Copperhead"])),col='red')
segments(3.95,(mean(platelets2$T3[platelets2$group=="Copperhead"])+sd(platelets2$T3[platelets2$group=="Copperhead"])),4.05,(mean(platelets2$T3[platelets2$group=="Copperhead"])+sd(platelets2$T3[platelets2$group=="Copperhead"])),col='red')

segments(5,mean(platelets2$T4[platelets2$group=="Rattlesnake"]),5,(mean(platelets2$T4[platelets2$group=="Rattlesnake"])-sd(platelets2$T4[platelets2$group=="Rattlesnake"])),col='black')
segments(4.95,(mean(platelets2$T4[platelets2$group=="Rattlesnake"])-sd(platelets2$T4[platelets2$group=="Rattlesnake"])),5.05,(mean(platelets2$T4[platelets2$group=="Rattlesnake"])-sd(platelets2$T4[platelets2$group=="Rattlesnake"])),col='black')
segments(5,mean(platelets2$T4[platelets2$group=="Copperhead"]),5,(mean(platelets2$T4[platelets2$group=="Copperhead"])+sd(platelets2$T4[platelets2$group=="Copperhead"])),col='red')
segments(4.95,(mean(platelets2$T4[platelets2$group=="Copperhead"])+sd(platelets2$T4[platelets2$group=="Copperhead"])),5.05,(mean(platelets2$T4[platelets2$group=="Copperhead"])+sd(platelets2$T4[platelets2$group=="Copperhead"])),col='red')
# Create box around plot
# box()
par(adj=0)
title(sub=expression("Figure 1. Average and standard deviation of Platelets" ~ 10^{9} ~ "/L count over time."))#,
dev.off()

######### GRAPH WITH SD VALUES
fibrinogen2<-na.omit(fibrinogen)
fibrinogen2<-as.data.frame(fibrinogen2)

#fibrinogen<-na.omit(fibrinogen)
fibrinogen_rs2<- c(
	with(subset(fibrinogen2,fibrinogen2$group=="Rattlesnake"),
		mean(na.omit(baseline))),
    with(subset(fibrinogen2,fibrinogen2$group=="Rattlesnake"),
    	mean(na.omit(T1))),
	with(subset(fibrinogen2,fibrinogen2$group=="Rattlesnake"),
...
fibrinogen_cp2<- c(
	with(subset(fibrinogen2,fibrinogen2$group=="Copperhead"),
		mean(na.omit(baseline))),
    with(subset(fibrinogen2,fibrinogen2$group=="Copperhead"),
    	mean(na.omit(T1))),
	with(subset(fibrinogen2,fibrinogen2$group=="Copperhead"),
...
tiff("/Users/jnv4/Desktop/fibrogen_SD.tiff", units='in', width = 8,
 height = 6,compression = 'lzw',res=1200,bg = "white")

plot(fibrinogen_rs2, type="o", pch=22, col="black", ylim=c(100,500),axes=FALSE, ann=FALSE)
lines(fibrinogen_cp2, type="o", pch=21, lty=2, col="red")
# Make x axis using tests labels
axis(1, at=1:5, lab=c("Baseline","Nadir","5 days" ,"8 days","15 days"))
...
legend(4, 180, c("Copperhead","Other Crotaline"), cex=0.8,
	col=c("red","black"), pch=c(21,22), lty=1:4,bg="white")
segments(1,mean(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"]),1,(mean(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(0.95,(mean(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])),1.05,(mean(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(1,mean(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"]),1,(mean(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])),col='red')
segments(0.95,(mean(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])),1.05,(mean(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])),col='red')

segments(2,mean(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"]),2,(mean(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(1.95,(mean(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])),2.05,(mean(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(2,mean(fibrinogen2$T1[fibrinogen2$group=="Copperhead"]),2,(mean(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])),col='red')
segments(1.95,(mean(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])),2.05,(mean(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])),col='red')

segments(3,mean(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"]),3,(mean(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(2.95,(mean(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])),3.05,(mean(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(3,mean(fibrinogen2$T2[fibrinogen2$group=="Copperhead"]),3,(mean(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])),col='red')
segments(2.95,(mean(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])),3.05,(mean(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])),col='red')

segments(4,mean(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"]),4,(mean(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(3.95,(mean(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])),4.05,(mean(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(4,mean(fibrinogen2$T3[fibrinogen2$group=="Copperhead"]),4,(mean(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])),col='red')
segments(3.95,(mean(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])),4.05,(mean(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])),col='red')

segments(5,mean(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"]),5,(mean(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(4.95,(mean(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])),5.05,(mean(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(5,mean(fibrinogen2$T4[fibrinogen2$group=="Copperhead"]),5,(mean(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])),col='red')
segments(4.95,(mean(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])),5.05,(mean(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])),col='red')

par(adj=0)
title(sub=expression("Figure 2.  Average and standard deviation of Fibrogen mg/dL count over time."))#,
dev.off()

######################################################
#GRAPHING W/OUT COLORS
######################################################
# #PLATELETS
# platelets<-as.data.frame(platelets)
# platelets<-na.omit(platelets)
...
tiff("/Users/jnv4/Desktop/platelets_colors.tiff", units='in', width = 8,
  height = 6,compression = 'lzw',res=1200,bg = "white")
...
points(c(rep(seq(4.8,5.2,0.05),2),4.8,5.2,5.0,4.8),
	subset(fibrinogen$T4,fibrinogen$group=="Copperhead"),
	col='grey50')
lines(fibrinogen_cp, type="o", col="grey50")
legend(4, 180, c("Copperhead","Other Crotaline"), cex=0.8,
	col=c("grey50","black"), pch=21:24, lty=1:4,bg="white")
par(adj=0)
	title(sub=expression("Figure 2.  Average (lines) and distribution (dots) of Fibrogen mg/dL count over time."))#,
...
tiff("/Users/jnv4/Desktop/platelets_SD_colors.tiff", units='in', width = 8,
 height = 6,compression = 'lzw',res=1200,bg = "white")
# postscript("/Users/jnv4/Desktop/platelets_SD.eps",width = 800, 
	# height = 600)
...
# PLATELETS
plot(platelets_cp2, type="o", col="grey50", ylim=c(100,350),axes=FALSE,
	ann=FALSE)
lines(platelets_rs2, type="o", pch=22, lty=2, col="black")
# Make x axis using tests labels
axis(1, at=1:5, lab=c("Baseline","Nadir","5 days" ,"8 days","15 days"))
...
title(ylab="Platelets") #, col.lab=rgb(0,0.5,0)
legend(4, 130, c("Copperhead","Other Crotaline"), cex=0.8,
	col=c("grey50","black"), pch=c(21,22), lty=1:4,bg="white")
segments(1,mean(platelets2$baseline[platelets2$group=="Rattlesnake"]),1,(mean(platelets2$baseline[platelets2$group=="Rattlesnake"])-sd(platelets2$baseline[platelets2$group=="Rattlesnake"])),col='black')
segments(0.95,(mean(platelets2$baseline[platelets2$group=="Rattlesnake"])-sd(platelets2$baseline[platelets2$group=="Rattlesnake"])),1.05,(mean(platelets2$baseline[platelets2$group=="Rattlesnake"])-sd(platelets2$baseline[platelets2$group=="Rattlesnake"])),col='black')
segments(1,mean(platelets2$baseline[platelets2$group=="Copperhead"]),1,(mean(platelets2$baseline[platelets2$group=="Copperhead"])+sd(platelets2$baseline[platelets2$group=="Copperhead"])),col='grey50')
segments(0.95,(mean(platelets2$baseline[platelets2$group=="Copperhead"])+sd(platelets2$baseline[platelets2$group=="Copperhead"])),1.05,(mean(platelets2$baseline[platelets2$group=="Copperhead"])+sd(platelets2$baseline[platelets2$group=="Copperhead"])),col='grey50')

segments(2,mean(platelets2$T1[platelets2$group=="Rattlesnake"]),2,(mean(platelets2$T1[platelets2$group=="Rattlesnake"])-sd(platelets2$T1[platelets2$group=="Rattlesnake"])),col='black')
segments(1.95,(mean(platelets2$T1[platelets2$group=="Rattlesnake"])-sd(platelets2$T1[platelets2$group=="Rattlesnake"])),2.05,(mean(platelets2$T1[platelets2$group=="Rattlesnake"])-sd(platelets2$T1[platelets2$group=="Rattlesnake"])),col='black')
segments(2,mean(platelets2$T1[platelets2$group=="Copperhead"]),2,(mean(platelets2$T1[platelets2$group=="Copperhead"])+sd(platelets2$T1[platelets2$group=="Copperhead"])),col='grey50')
segments(1.95,(mean(platelets2$T1[platelets2$group=="Copperhead"])+sd(platelets2$T1[platelets2$group=="Copperhead"])),2.05,(mean(platelets2$T1[platelets2$group=="Copperhead"])+sd(platelets2$T1[platelets2$group=="Copperhead"])),col='grey50')

segments(3,mean(platelets2$T2[platelets2$group=="Rattlesnake"]),3,(mean(platelets2$T2[platelets2$group=="Rattlesnake"])-sd(platelets2$T2[platelets2$group=="Rattlesnake"])),col='black')
segments(2.95,(mean(platelets2$T2[platelets2$group=="Rattlesnake"])-sd(platelets2$T2[platelets2$group=="Rattlesnake"])),3.05,(mean(platelets2$T2[platelets2$group=="Rattlesnake"])-sd(platelets2$T2[platelets2$group=="Rattlesnake"])),col='black')
segments(3,mean(platelets2$T2[platelets2$group=="Copperhead"]),3,(mean(platelets2$T2[platelets2$group=="Copperhead"])+sd(platelets2$T2[platelets2$group=="Copperhead"])),col='grey50')
segments(2.95,(mean(platelets2$T2[platelets2$group=="Copperhead"])+sd(platelets2$T2[platelets2$group=="Copperhead"])),3.05,(mean(platelets2$T2[platelets2$group=="Copperhead"])+sd(platelets2$T2[platelets2$group=="Copperhead"])),col='grey50')

segments(4,mean(platelets2$T3[platelets2$group=="Rattlesnake"]),4,(mean(platelets2$T3[platelets2$group=="Rattlesnake"])-sd(platelets2$T3[platelets2$group=="Rattlesnake"])),col='black')
segments(3.95,(mean(platelets2$T3[platelets2$group=="Rattlesnake"])-sd(platelets2$T3[platelets2$group=="Rattlesnake"])),4.05,(mean(platelets2$T3[platelets2$group=="Rattlesnake"])-sd(platelets2$T3[platelets2$group=="Rattlesnake"])),col='black')
segments(4,mean(platelets2$T3[platelets2$group=="Copperhead"]),4,(mean(platelets2$T3[platelets2$group=="Copperhead"])+sd(platelets2$T3[platelets2$group=="Copperhead"])),col='grey50')
segments(3.95,(mean(platelets2$T3[platelets2$group=="Copperhead"])+sd(platelets2$T3[platelets2$group=="Copperhead"])),4.05,(mean(platelets2$T3[platelets2$group=="Copperhead"])+sd(platelets2$T3[platelets2$group=="Copperhead"])),col='grey50')

segments(5,mean(platelets2$T4[platelets2$group=="Rattlesnake"]),5,(mean(platelets2$T4[platelets2$group=="Rattlesnake"])-sd(platelets2$T4[platelets2$group=="Rattlesnake"])),col='black')
segments(4.95,(mean(platelets2$T4[platelets2$group=="Rattlesnake"])-sd(platelets2$T4[platelets2$group=="Rattlesnake"])),5.05,(mean(platelets2$T4[platelets2$group=="Rattlesnake"])-sd(platelets2$T4[platelets2$group=="Rattlesnake"])),col='black')
segments(5,mean(platelets2$T4[platelets2$group=="Copperhead"]),5,(mean(platelets2$T4[platelets2$group=="Copperhead"])+sd(platelets2$T4[platelets2$group=="Copperhead"])),col='grey50')
segments(4.95,(mean(platelets2$T4[platelets2$group=="Copperhead"])+sd(platelets2$T4[platelets2$group=="Copperhead"])),5.05,(mean(platelets2$T4[platelets2$group=="Copperhead"])+sd(platelets2$T4[platelets2$group=="Copperhead"])),col='grey50')
# Create box around plot
# box()
par(adj=0)
title(sub=expression("Figure 1. Average and standard deviation of Platelets" ~ 10^{9} ~ "/L count over time."))#,
...
tiff("/Users/jnv4/Desktop/fibrogen_SD_colors.tiff", units='in', width = 8,
 height = 6,compression = 'lzw',res=1200,bg = "white")

plot(fibrinogen_rs2, type="o", pch=22, col="black", ylim=c(100,500),axes=FALSE, ann=FALSE)
lines(fibrinogen_cp2, type="o", pch=21, lty=2, col="grey50")
# Make x axis using tests labels
axis(1, at=1:5, lab=c("Baseline","Nadir","5 days" ,"8 days","15 days"))
axis(2, at=seq(from = 100, to = 500, by = 30))
# Create box around plot
...
segments(1,mean(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"]),1,(mean(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(0.95,(mean(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])),1.05,(mean(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$baseline[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(1,mean(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"]),1,(mean(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])),col='grey50')
segments(0.95,(mean(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])),1.05,(mean(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$baseline[fibrinogen2$group=="Copperhead"])),col='grey50')

segments(2,mean(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"]),2,(mean(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(1.95,(mean(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])),2.05,(mean(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T1[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(2,mean(fibrinogen2$T1[fibrinogen2$group=="Copperhead"]),2,(mean(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])),col='grey50')
segments(1.95,(mean(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])),2.05,(mean(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T1[fibrinogen2$group=="Copperhead"])),col='grey50')

segments(3,mean(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"]),3,(mean(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(2.95,(mean(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])),3.05,(mean(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T2[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(3,mean(fibrinogen2$T2[fibrinogen2$group=="Copperhead"]),3,(mean(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])),col='grey50')
segments(2.95,(mean(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])),3.05,(mean(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T2[fibrinogen2$group=="Copperhead"])),col='grey50')

segments(4,mean(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"]),4,(mean(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(3.95,(mean(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])),4.05,(mean(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T3[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(4,mean(fibrinogen2$T3[fibrinogen2$group=="Copperhead"]),4,(mean(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])),col='grey50')
segments(3.95,(mean(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])),4.05,(mean(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T3[fibrinogen2$group=="Copperhead"])),col='grey50')

segments(5,mean(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"]),5,(mean(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(4.95,(mean(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])),5.05,(mean(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])-sd(fibrinogen2$T4[fibrinogen2$group=="Rattlesnake"])),col='black')
segments(5,mean(fibrinogen2$T4[fibrinogen2$group=="Copperhead"]),5,(mean(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])),col='grey50')
segments(4.95,(mean(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])),5.05,(mean(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])+sd(fibrinogen2$T4[fibrinogen2$group=="Copperhead"])),col='grey50')
...
# #PLATELETS
# plot(platelets_cp, type="o", col="grey50", ylim=c(150,350),axes=FALSE, ann=FALSE)
