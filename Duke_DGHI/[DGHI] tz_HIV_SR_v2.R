...
data<-read.csv("/Users/Joao/Box/Home Folder jnv4/Data/Global EM/Africa/Tz/HIV/tz_hiv_SR_v2.csv")


data2<-read.csv("/Users/Joao/Box/Home Folder jnv4/Data/Global EM/Africa/Tz/HIV/tz_hiv_fig3.csv")


data3<-read.csv("/Users/Joao/Box/Home Folder jnv4/Data/Global EM/Africa/Tz/HIV/tz_hiv_fig5.csv")
...
# setEPS()
# # tiff("/Users/Joao/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
...
postscript("/Users/Joao/Desktop/figure4_age.eps",
	width = 10, height = 8)
...
setEPS()
# tiff("/Users/Joao/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/Joao/Desktop/figure_RNA.eps",
	width = 10, height = 6)
...
# setEPS()
# # tiff("/Users/Joao/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
# postscript("/Users/Joao/Desktop/figure_RNAfunnel.eps",
# 	width = 8, height = 6)
# #funnel
...
postscript("/Users/Joao/Desktop/figureS2_HIVduration.eps",
	width = 10, height = 6)
...
# setEPS()
# # tiff("/Users/Joao/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
# postscript("/Users/Joao/Desktop/figure_gender.eps",
# 	width = 14, height = 12)
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/Joao/Desktop/figure7_gender.eps",
	width = 10, height = 8)
forest(meta_fig2gender,sortvar=meta_fig2gender$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
# setEPS()
# # tiff("/Users/Joao/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
# postscript("/Users/Joao/Desktop/figure_race.eps",
# 	width = 14, height = 12)
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/Joao/Desktop/figure6_race.eps",
	width = 10, height = 6)
forest(meta_fig2race,sortvar=meta_fig2race$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/Joao/Desktop/figureS7_smoking.eps",
	width = 10, height = 8)
forest(meta_fig2smoking,sortvar=meta_fig2smoking$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/Joao/Desktop/figureS5_currentCD4.eps",
	width = 10, height = 6)
forest(meta_fig2current_CD_4,sortvar=meta_fig2current_CD_4$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/Joao/Desktop/figureS4_CD4nadir.eps",
	width = 10, height = 6)
forest(meta_fig2mean_CD_4_nadir,sortvar=meta_fig2mean_CD_4_nadir$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
#############################################################################
#
#Figure 3 - by CART Duration < 5 years model
#
#############################################################################

data_5ART<-subset(data,data$ART_duration_5years!="")
...
# data_5ART$ART_duration_5years<-as.character(data_5ART$ART_duration_5years)

#meta-regression
levels(data_5ART$ART_duration_5years)
metareg(meta_fig1, ~ ART_duration_5years)

#run metanalysis model for type of intervention
meta_fig2ART_duration_5years <- metacont(n_HIV_pos,
	Mean_cIMT_HIVpos,
	SD_cIMT_HIVpos,
	n_HIV_neg,
	Mean_cIMT_HIVneg,
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/Joao/Desktop/figureS3_HIVdurationless5years.eps",
	width = 10, height = 6)
forest(meta_fig2ART_duration_5years,sortvar=meta_fig2ART_duration_5years$TE,
					   bysort=FALSE,
					   digits.mean=2,
					   digits.sd=2,
					   layout="JAMA",
...
data_5ARTabove10<-subset(data_5ART,data_5ART$ART_duration=="Duration of HIV above 10 years")

data_5ARTabove10$ART_duration<-as.character(data_5ARTabove10$ART_duration)
...
meta_fig2ART_duration_above5 <- metacont(n_HIV_pos,
	...
	Mean_cIMT_HIVneg,
	SD_cIMT_HIVneg, 
  data=data_5ARTabove10, 
  sm="SMD",
  # byvar=ART_duration,
  # print.byvar=FALSE,
  # comb.fixed=FALSE,
  studlab=data_5ARTabove10[,1])
...
data_5ART_duration_below10<-subset(data,data$ART_duration=="Duration of HIV below or equal to 10 years")

data_5ART_duration_below10$ART_duration<-as.character(data_5ART_duration_below10$ART_duration)
...
meta_fig2ART_duration_below5 <- metacont(n_HIV_pos,
	...
	Mean_cIMT_HIVneg,
	SD_cIMT_HIVneg, 
  data=data_5ART_duration_below10, 
  sm="SMD",
  # byvar=ART_duration,
  # print.byvar=FALSE,
  # comb.fixed=FALSE,
  studlab=data_5ART_duration_below10[,1])
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/Joao/Desktop/figure5.eps",
	width = 10, height = 6)
forest(meta_fig5,sortvar=meta_fig5$TE,
					   bysort=FALSE,
					   digits.mean=2,
					   digits.sd=2,
					   layout="JAMA",
...
random = rma(yi=SMD, sei=SE, data=data2)
