...
# Get data
data2009<-read.csv("/Users/jnv4/Box Sync/Home Folder jnv4/Data/Global EM/baltimore_gis/paper 1/crashdata2009_datecoded.csv")
data2010<-read.csv("/Users/jnv4/Box Sync/Home Folder jnv4/Data/Global EM/baltimore_gis/paper 1/crashdata2010_datecoded.csv")
data2011<-read.csv("/Users/jnv4/Box Sync/Home Folder jnv4/Data/Global EM/baltimore_gis/paper 1/crashdata2011_datecoded.csv")
data2012<-read.csv("/Users/jnv4/Box Sync/Home Folder jnv4/Data/Global EM/baltimore_gis/paper 1/crashdata2012_datecoded.csv")
data2013<-read.csv("/Users/jnv4/Box Sync/Home Folder jnv4/Data/Global EM/baltimore_gis/paper 1/crashdata2013_datecoded.csv")
...
# data=read.table("eniuce.csv",sep=",",header=T)
# head(data)

timeseries_data <- ts(time_series_month$prev_crashes_month,
                      start=c(2009,1),frequency=12)
