...
#ROAD AREA
data_tz$road_area<-data_tz$road_area
data_rw$road_area<-data_rw$road_urban
data_sl2$road_area<-data_sl2$road_area

#ROAD DESIGN
data_tz$road_design<-data_tz$road_design
data_rw$road_design<-data_rw$aroad_design
data_sl2$road_design<-data_sl2$road_design
