...
devtools::install_github("nutterb/redcapAPI", ref = "devel")

remove.packages("redcapAPI")
...
rcon <- redcapConnection(url='https://redcap.duke.edu/redcap/api/', token='A6CA2CE897EC220DC54B5F8078D65DB0')
data <- exportRecords(rcon)

token <- "A6CA2CE897EC220DC54B5F8078D65DB0"
...
# dictionary<-read.csv("/Users/joaovissoci/Downloads/TraumaRegistryKCMC2020_DataDictionary_2020-12-08.csv")

# cleanseMetaData(dictionary)
...
dbHeader$children[[2]]$children <- tags$img(src="Gemini-01.png", height=56, width=429)
...
# PRACT screening data by week
  ...
  data_screening_date2<-as.data.frame(data_screening_date2)
