...
start_date<-floor_date(today(), "week", 1) # if Monday the current day
    ...
    tabItems(
      ...
      tabItem(tabName = "dashboard",
              ...
              fluidRow(
                ...
                box(
                  title = "High level of missings", width = 4, solidHeader = TRUE, status = "danger", data_date_subset$enrolled
                )),
              fluidRow( 
                box(
