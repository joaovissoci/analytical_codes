    ...
    tabItems(
      ...
      tabItem(tabName = "dashboard",
              ...
              fluidRow(
                ...
                box(
                  title = "High level of missings", width = 4, solidHeader = TRUE, status = "danger", paste(plot1_data_week$names,collapse="\n -")
                )
                #box(
...
# if (as.numeric(input$tables)==TRUE) {
