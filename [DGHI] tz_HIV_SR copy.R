...
postscript("/Users/joaovissoci/Desktop/figure3_ART_duration_v2.eps",
	width = 14, height = 6)
...
setEPS()
# tiff("/Users/joaovissocivissoci/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure3_ART_duration.eps",
	width = 14, height = 8)
forest(meta_fig2ART_duration,sortvar=meta_fig2ART_duration$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
setEPS()
# tiff("/Users/joaovissoci/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure4_gender.eps",
	width = 14, height = 12)
...
postscript("/Users/joaovissoci/Desktop/figure4_gender_v2.eps",
	width = 14, height = 6)
forest(meta_fig2ART_duration,sortvar=meta_fig2ART_duration$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
setEPS()
# tiff("/Users/joaovissoci/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure5_race.eps",
	width = 14, height = 12)
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure5_race_v2.eps",
	width = 14, height = 6)
forest(meta_fig2ART_duration,sortvar=meta_fig2ART_duration$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
setEPS()
# tiff("/Users/joaovissoci/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure6_smoking.eps",
	width = 14, height = 12)
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure6_smoking_v2.eps",
	width = 14, height = 6)
forest(meta_fig2ART_duration,sortvar=meta_fig2ART_duration$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
#############################################################################
#
#Figure 7 - by mean_CD_4
#
#############################################################################

data_mean_CD_4<-subset(data,data$mean_CD_4!="")
...
meta_fig1 <- metacont(n_HIV_pos,
  ...
  # print.byvar=FALSE,
  # comb.fixed=FALSE,
  studlab=data_mean_CD_4[,1])

#meta-regression
metareg(meta_fig1, ~ mean_CD_4)

data_mean_CD_4$mean_CD_4<-as.character(data_mean_CD_4$mean_CD_4)

#run metanalysis model for type of intervention
meta_fig2mean_CD_4 <- metacont(n_HIV_pos,
	Mean_cIMT_HIVpos,
	SD_cIMT_HIVpos,
	n_HIV_neg,
	Mean_cIMT_HIVneg,
...
setEPS()
# tiff("/Users/joaovissoci/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure6_mean_CD_4.eps",
	width = 14, height = 12)
forest(meta_fig2mean_CD_4,sortvar=meta_fig2mean_CD_4$TE,
					   bysort=FALSE,
					   digits.mean=2,
					   digits.sd=2,
					   print.byvar=FALSE)
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure6_mean_CD_4_v2.eps",
	width = 14, height = 6)
forest(meta_fig2ART_duration,sortvar=meta_fig2ART_duration$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
data_mean_CD_4_nodiff<-subset(data_mean_CD_4,data_mean_CD_4$mean_CD_4=="No difference")

data_mean_CD_4_nodiff$mean_CD_4<-as.character(data_mean_CD_4_nodiff$mean_CD_4)

#run metanalysis model for type of intervention
meta_fig2mean_CD_4_nodiff <- metacont(n_HIV_pos,
	Mean_cIMT_HIVpos,
	SD_cIMT_HIVpos,
	n_HIV_neg,
	Mean_cIMT_HIVneg,
	SD_cIMT_HIVneg, 
  data=data_mean_CD_4_nodiff, 
  sm="SMD",
  # byvar=mean_CD_4,
  # print.byvar=FALSE,
  # comb.fixed=FALSE,
  studlab=data_mean_CD_4_nodiff[,1])

# metainf(meta1)
metainf(meta_fig2mean_CD_4_nodiff, pooled="random")
# metareg(meta_fig1, ~ mean_CD_4 + mean_CD_4 + mean_CD_4)

#funnel
funnel(meta_fig2mean_CD_4_nodiff)

# mean_CD_4 below 5 sub-group
################################################################

#mean_CD_4 below 40 years

data_mean_CD_4_sigdiff<-subset(data,data$mean_CD_4=="Sig. difference")

data_mean_CD_4_sigdiff$mean_CD_4<-as.character(data_mean_CD_4_sigdiff$mean_CD_4)

#run metanalysis model for type of intervention
meta_fig2mean_CD_4_sigdiff <- metacont(n_HIV_pos,
	Mean_cIMT_HIVpos,
	SD_cIMT_HIVpos,
	n_HIV_neg,
	Mean_cIMT_HIVneg,
	SD_cIMT_HIVneg, 
  data=data_mean_CD_4_sigdiff, 
  sm="SMD",
  # byvar=mean_CD_4,
  # print.byvar=FALSE,
  # comb.fixed=FALSE,
  studlab=data_mean_CD_4_sigdiff[,1])

# metainf(meta1)
metainf(meta_fig2mean_CD_4_sigdiff, pooled="random")
# metareg(meta_fig1, ~ mean_CD_4 + mean_CD_4 + mean_CD_4)

#funnel
funnel(meta_fig2mean_CD_4_sigdiff)
...
setEPS()
# tiff("/Users/joaovissoci/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure6_current_CD_4.eps",
	width = 14, height = 12)
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure6_current_CD_4_v2.eps",
	width = 14, height = 6)
forest(meta_fig2ART_duration,sortvar=meta_fig2ART_duration$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
# current_CD_4 sub-group
################################################################

#Male

data_current_CD_4_nodiff<-subset(data_current_CD_4,data_current_CD_4$current_CD_4=="No difference")

data_current_CD_4_nodiff$current_CD_4<-as.character(data_current_CD_4_nodiff$current_CD_4)
...
meta_fig2current_CD_4_nodiff <- metacont(n_HIV_pos,
	...
	Mean_cIMT_HIVneg,
	SD_cIMT_HIVneg, 
  data=data_current_CD_4_nodiff, 
  sm="SMD",
  # byvar=current_CD_4,
  # print.byvar=FALSE,
  # comb.fixed=FALSE,
  studlab=data_current_CD_4_nodiff[,1])

# metainf(meta1)
metainf(meta_fig2current_CD_4_nodiff, pooled="random")
# metareg(meta_fig1, ~ current_CD_4 + current_CD_4 + current_CD_4)

#funnel
funnel(meta_fig2current_CD_4_nodiff)

# current_CD_4 below 5 sub-group
################################################################

#current_CD_4 below 40 years

data_current_CD_4_sigdiff<-subset(data,data$current_CD_4=="Sig. difference")

data_current_CD_4_sigdiff$current_CD_4<-as.character(data_current_CD_4_sigdiff$current_CD_4)

#run metanalysis model for type of intervention
meta_fig2current_CD_4_sigdiff <- metacont(n_HIV_pos,
	Mean_cIMT_HIVpos,
	SD_cIMT_HIVpos,
	n_HIV_neg,
	Mean_cIMT_HIVneg,
	SD_cIMT_HIVneg, 
  data=data_current_CD_4_sigdiff, 
  sm="SMD",
  # byvar=current_CD_4,
  # print.byvar=FALSE,
  # comb.fixed=FALSE,
  studlab=data_current_CD_4_sigdiff[,1])

# metainf(meta1)
metainf(meta_fig2current_CD_4_sigdiff, pooled="random")
# metareg(meta_fig1, ~ current_CD_4 + current_CD_4 + current_CD_4)

#funnel
funnel(meta_fig2current_CD_4_sigdiff)
...
data_RNA$RNA<-as.character(data_RNA$RNA)
...
setEPS()
# tiff("/Users/joaovissoci/Desktop/depression_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure6_RNA.eps",
	width = 14, height = 12)
...
setEPS()
# tiff("/Users/Joao/Desktop/dep3ession_sr_network.tiff", width = 16, height = 8, units='in',compression = 'rle', res = 300)
postscript("/Users/joaovissoci/Desktop/figure6_RNA_v2.eps",
	width = 14, height = 6)
forest(meta_fig2ART_duration,sortvar=meta_fig2ART_duration$TE,
					   bysort=FALSE,
					   digits.mean=2,
...
data_RNA_nodiff<-subset(data_RNA,data_RNA$RNA=="No difference")

data_RNA_nodiff$RNA<-as.character(data_RNA_nodiff$RNA)

#run metanalysis model for type of intervention
meta_fig2RNA_nodiff <- metacont(n_HIV_pos,
	Mean_cIMT_HIVpos,
	SD_cIMT_HIVpos,
	n_HIV_neg,
	Mean_cIMT_HIVneg,
	SD_cIMT_HIVneg, 
  data=data_RNA_nodiff, 
  sm="SMD",
  # byvar=RNA,
  # print.byvar=FALSE,
  # comb.fixed=FALSE,
  studlab=data_RNA_nodiff[,1])

# metainf(meta1)
metainf(meta_fig2RNA_nodiff, pooled="random")
# metareg(meta_fig1, ~ RNA + RNA + RNA)

#funnel
funnel(meta_fig2RNA_nodiff)

# RNA below 5 sub-group
################################################################

#RNA below 40 years

data_RNA_sigdiff<-subset(data,data$RNA=="Sig. difference")

data_RNA_sigdiff$RNA<-as.character(data_RNA_sigdiff$RNA)

#run metanalysis model for type of intervention
meta_fig2RNA_sigdiff <- metacont(n_HIV_pos,
	Mean_cIMT_HIVpos,
	SD_cIMT_HIVpos,
	n_HIV_neg,
	Mean_cIMT_HIVneg,
	SD_cIMT_HIVneg, 
  data=data_RNA_sigdiff, 
  sm="SMD",
  # byvar=RNA,
  # print.byvar=FALSE,
  # comb.fixed=FALSE,
  studlab=data_RNA_sigdiff[,1])

# metainf(meta1)
metainf(meta_fig2RNA_sigdiff, pooled="random")
# metareg(meta_fig1, ~ RNA + RNA + RNA)

#funnel
funnel(meta_fig2RNA_sigdiff)
