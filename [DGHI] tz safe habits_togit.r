...
data<-read.csv("/Users/joaovissoci/Box Sync/Home Folder jnv4/Data/Global EM/Africa/Tz/safe_habits_tz/tz_safet_habits_data.csv",sep=',')
...
######################################################
# Age
by(data_all$age,data_all$injury,describe)
# wilcox.test(demographics$age~outcomes$injury)

# # Experience (Years)
by(data_all$years_work_onbodaboda,data_all$injury,describe)
# wilcox.test(work_experience$years_work_onbodaboda~outcomes$injury)

# # Hours of Work
by(data_all$hours_work_onbodaboda,data_all$injury,describe)
...
age_num<-as.numeric(as.character(data_all$age))
years_work_onbodaboda_num<-as.numeric(as.character(data_all$years_work_onbodaboda))
hours_work_week_num<-as.numeric(as.character(data_all$hours_work_week))
helmet_cracks_num<-as.numeric(as.character(data_all$helmet_cracks))
work_night_num<-as.numeric(data_all$work_night)
safety_helmet_use_num<-as.numeric(as.character(data_all$safety_helmet_use))
safety_buckle_helmet_num<-as.numeric(as.character(data_all$safety_buckle_helmet))
helmet_obscure_face_shield_num<-as.numeric(as.character(data_all$helmet_obscure_face_shield))
helmet_face_shield_num<-as.numeric(as.character(data_all$helmet_face_shield))
helmet_fit_num<-as.numeric(as.character(data_all$helmet_fit))
safety_headlight_use_day_num<-as.numeric(as.character(data_all$safety_headlight_use_day))
safety_headlight_use_night_num<-as.numeric(as.character(data_all$safety_headlight_use_night))
safety_purchase_helmet_after_use_num<-as.numeric(as.character(data_all$safety_purchase_helmet_after_use))
safety_belief_helmet_reduce_risk_num<-as.numeric(as.character(data_all$safety_belief_helmet_reduce_risk))
safety_buckle_helmet_num<-as.numeric(as.character(data_all$safety_buckle_helmet))
safety_belief_helmetstraps_reduce_risk_num<-as.numeric(as.character(data_all$safety_belief_helmetstraps_reduce_risk))

cor_auto(data.frame(age_num,
years_work_onbodaboda_num,
hours_work_week_num,
helmet_cracks_num,
work_night_num,
safety_helmet_use_num,
safety_buckle_helmet_num,
helmet_obscure_face_shield_num,
helmet_face_shield_num,
helmet_fit_num,
safety_headlight_use_day_num,
safety_headlight_use_night_num,
safety_purchase_helmet_after_use_num,
safety_belief_helmet_reduce_risk_num,
safety_belief_helmetstraps_reduce_risk_num
))
...
# Age
by(data_all$age,data_all$nearmissmonth,describe)
# wilcox.test(demographics$age~outcomes$nearmissmonth)

# # Experience (Years)
by(data_all$years_work_onbodaboda,data_all$nearmissmonth,describe)
# wilcox.test(work_experience$years_work_onbodaboda~outcomes$nearmissmonth)

# # Hours of Work
by(data_all$hours_work_onbodaboda,data_all$nearmissmonth,describe)
# wilcox.test(work_experience$hours_work_onbodaboda~outcomes$nearmissmonth)
